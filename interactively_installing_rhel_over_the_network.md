...
[Legal Notice](#idm140554908469424)
...
<h2 id="installing-rhel-using-satellite-server">Chapter 4. Installing RHEL using Satellite Server</h2>

Red Hat Satellite is a centralized tool for provisioning, remote management, and monitoring of multiple Red Hat Enterprise Linux deployments. With Satellite, you can deploy physical and virtual hosts. This includes setting up network topology and configuring services. It also provides configuration details needed to provision hosts on your network.

Important

For information about provisioning hosts, refer to the [*Satellite documentation*](https://docs.redhat.com/documentation/en-us/red_hat_satellite/). From the documentation portal, select the version of Satellite that matches your deployment to access the appropriate *Provisioning Hosts* guide. Documentation for unsupported versions is marked as deprecated and is intended for reference only. Verify that you are viewing a supported version to ensure access to the most accurate and up-to-date information.
...
<h2 id="rhel-installations-on-ibm-power-servers">Chapter 8. RHEL Installations on IBM Power Servers</h2>

You can install Red Hat Enterprise Linux on various IBM Power System servers.

<h3 id="supported-ibm-power-servers">8.1. Supported IBM Power Servers</h3>

You can install Red Hat Enterprise Linux on IBM Power Systems. You can find the complete list of supported IBM Power servers on the [Red Hat Ecosystem Catalog](https://catalog.redhat.com/hardware/search?p=1&c_catalog_channel=Server&chArchitectures=ppc64le&c_version=Red%20Hat%20Enterprise%20Linux%209&rows=60).

<h3 id="overview-of-the-installation-process-on-powervm-lpar-by-using-the-hmc">8.2. Overview of the installation process on PowerVM LPAR by using the HMC</h3>
...
- [Installing Linux on PowerVM LPAR by using the HMC](https://www.ibm.com/docs/en/linux-on-systems?topic=systems-installing-linux-powervm-lpar-by-using-hmc)
- [Service and productivity tools](https://www.ibm.com/support/pages/service-and-productivity-tools)
- [Add or remove connections to HMC](https://www.ibm.com/docs/en/power10/7063-CR2?topic=connections-reset-remove)

<h3 id="overview-of-the-installation-process-on-ibm-power-servers-with-the-graphics-card">8.3. Overview of the installation process on IBM Power Servers with the graphics card</h3>
...
- [Installing Linux on Power Systems servers with a graphics card](https://www.ibm.com/docs/en/linux-on-systems?topic=systems-installing-linux-power-servers-graphics-card)
- [Service and productivity tools](https://www.ibm.com/support/pages/service-and-productivity-tools)

<h2 id="preparing-a-rhel-installation-on-64-bit-ibm-z">Chapter 9. Preparing a RHEL installation on 64-bit IBM Z</h2>

You can install Red Hat Enterprise Linux on the 64-bit IBM Z architecture.

<h3 id="planning-for-installation-on-64-bit-ibm-z">9.1. Planning for installation on 64-bit IBM Z</h3>
...
<h3 id="boot-media-compatibility-for-ibm-z-servers">9.2. Boot media compatibility for IBM Z servers</h3>
...
<h3 id="supported-environments-and-components-for-ibm-z-servers">9.3. Supported environments and components for IBM Z servers</h3>
...
Table 9.1. Network device compatibility for system types
...
Table 9.2. Machine type compatibility for system types
...
|:------------------------------------------------------------------------|:-----|:------------------------------------|:-----|
| DASD                                                                    | Yes  | Yes                                 | Yes  |
| FCP SCSI                                                                | Yes  | Yes[\[a\]](#ftn.idm140554905191760) | Yes  |
| virtio-blk                                                              | N/A  | Yes                                 | N/A  |
| [\[a\]](#idm140554905191760) Conditional support based on configuration |      |                                     |      |

Table 9.3. Storage type compatibility for system types

N/A indicates that the component is not applicable for the specified system type.

<h3 id="overview-of-installation-process-on-64-bit-ibm-z-servers">9.4. Overview of installation process on 64-bit IBM Z servers</h3>
...
<h3 id="boot-media-for-installing-rhel-on-64-bit-ibm-z-servers">9.5. Boot media for installing RHEL on 64-bit IBM Z servers</h3>
...
<h3 id="customization-of-boot-parameters">9.6. Customization of boot parameters</h3>
...
- [`inst.repo`](#installation-source-boot-options "26.1. Installation source boot options")
- [`ip=`](#network-boot-options "26.2. Network boot options")

<h3 id="preparing-an-installation-in-a-z-vm-guest-virtual-machine">9.7. Preparing an installation in a z/VM guest virtual machine</h3>
...
<h3 id="parameters-and-configuration-files-on-64-bit-ibm-z">9.8. Parameters and configuration files on 64-bit IBM Z</h3>

You can customize and configure RHEL by using the parameters and configuration files on 64-bit IBM Z.

<h4 id="required-configuration-file-parameters-on-64-bit-ibm-z">9.8.1. Required configuration file parameters on 64-bit IBM Z</h4>
...
<h4 id="ibm-z-64-bit-vm-configuration-file">9.8.2. 64-bit IBM z/VM configuration file</h4>
...
<h4 id="installation-network-dasd-and-fcp-parameters-on-64-bit-ibm-z">9.8.3. Installation network, DASD and FCP parameters on 64-bit IBM Z</h4>
...
<h4 id="miscellaneous-parameters-on-64-bit-ibm-z">9.8.4. Additional Boot Parameters for 64-bit IBM Z</h4>
...
<h4 id="sample-parameter-file-and-cms-configuration-file-on-64-bit-ibm-z">9.8.5. Sample parameter file and CMS configuration file on 64-bit IBM Z</h4>
...
<h2 id="creating-a-kernel-based-virtual-machine-and-booting-the-installation-iso-in-the-vm">Chapter 10. Creating a kernel-based virtual machine and booting the installation ISO in the VM</h2>
...
<h2 id="booting-the-installation-media">Chapter 11. Booting the installation media</h2>
...
<h3 id="booting-the-installation-from-a-network-using-http">11.1. Booting the installation from a network using HTTP</h3>
...
- Your platform is x86\_64 or you install in KVM.
...
3. Use the arrow keys on your keyboard to select the boot option that you require, and press `Enter` to select the boot option. The installation program gets started and you can install Red Hat Enterprise Linux using the graphical or text user interface.
...
4. Optional: Edit the available boot options.
...
- [Automatically installing RHEL](https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/10/html-single/automatically_installing_rhel/index)

<h3 id="booting-the-installation-from-a-network-using-pxe">11.2. Booting the installation from a network using PXE</h3>
...
3. Use the arrow keys on your keyboard to select the boot option that you require, and press `Enter` to select the boot option. The installation program gets started and you can install Red Hat Enterprise Linux by using the graphical or text user interface.
...
- [Automatically installing RHEL](https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/10/html/automatically_installing_rhel/index)
- [Boot options reference](#boot-options-reference "Chapter 26. Boot options reference")

<h3 id="installing-in-an-lpar">11.3. Booting the installation on IBM Z to install RHEL in an LPAR</h3>

You can boot the installation on IBM Z to install RHEL in an LPAR.

<h4 id="booting-the-rhel-installation-from-an-sftp-ftps-or-ftp-server-to-install-in-an-ibm-z-lpar">11.3.1. Booting the RHEL installation from an SFTP, FTPS, or FTP server to install in an IBM Z LPAR</h4>
...
<h4 id="booting-the-rhel-installation-from-a-prepared-dasd-to-install-in-an-ibm-z-lpar">11.3.2. Booting the RHEL installation from a prepared DASD to install in an IBM Z LPAR</h4>
...
<h4 id="booting-the-rhel-installation-from-an-fcp-attached-scsi-disk-to-install-in-an-ibm-z-lpar">11.3.3. Booting the RHEL installation from an FCP-attached SCSI disk to install in an IBM Z LPAR</h4>
...
<h3 id="booting-the-installation-on-ibm-z-to-install-rhel-in-zvm">11.4. Booting the installation on IBM Z to install RHEL in z/VM</h3>
...
<h4 id="booting-the-rhel-installation-by-using-the-z-vm-reader">11.4.1. Booting the RHEL installation by using the z/VM Reader</h4>
...
5. Customize boot parameters in `generic.prm` as necessary. For details, see [Customizing boot parameters](#customization-of-boot-parameters "9.6. Customization of boot parameters").
...
<h4 id="booting-the-rhel-installation-by-using-a-prepared-dasd">11.4.2. Booting the RHEL installation by using a prepared DASD</h4>
...
<h4 id="booting-the-rhel-installation-by-using-a-prepared-fcp-attached-scsi-disk">11.4.3. Booting the RHEL installation by using a prepared FCP-attached SCSI disk</h4>
...
<h2 id="optional-customizing-boot-options">Chapter 12. Optional: Customizing boot options</h2>
...
<h3 id="types-of-boot-options">12.1. Boot options</h3>
...
- [Editing the GRUB2 menu](#editing-the-grub2-menu-for-the-uefi-based-systems "12.2. Editing the GRUB2 menu")
- [Boot options reference](#boot-options-reference "Chapter 26. Boot options reference")

<h3 id="editing-the-grub2-menu-for-the-uefi-based-systems">12.2. Editing the GRUB2 menu</h3>
...
<h2 id="updating-drivers-during-installation">Chapter 13. Updating drivers during installation</h2>
...
<h3 id="overview">13.1. Overview</h3>
...
<h3 id="types-of-driver-update">13.2. Types of driver update</h3>
...
<h3 id="preparing-a-driver-update">13.3. Preparing a driver update CD or DVD</h3>
...
<h3 id="preparing-a-driver-update-usb-drive">13.4. Preparing a driver update USB drive</h3>
...
<h3 id="performing-an-automatic-driver-update">13.5. Performing an automatic driver update</h3>
...
<h3 id="performing-an-assisted-driver-update">13.6. Performing an assisted driver update</h3>
...
<h3 id="performing-a-manual-driver-update">13.7. Performing a manual driver update</h3>
...
<h3 id="disabling-a-driver">13.8. Disabling a driver</h3>
...
<h2 id="preparing-a-remote-installation-by-using-rdp">Chapter 14. Preparing a remote installation by using RDP</h2>

You must prepare to perform a remote installation by using the Remote Desktop Protocol.

<h3 id="remote-desktop-protocol-overview">14.1. Remote desktop protocol overview</h3>
...
<h3 id="considerations-for-using-remote-desktop-protocol">14.2. Considerations for using remote desktop protocol</h3>
...
- [Configuring the firewall](https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/10/html/configuring_firewalls_and_packet_filters/index)

<h2 id="starting-a-remote-installation-by-using-the-remote-desktop-protocol">Chapter 15. Starting a remote installation by using the Remote Desktop Protocol</h2>

You can start remote installation by using the Remote Desktop Protocol.

<h3 id="performing-a-remote-rhel-installation-with-an-rdp-client">15.1. Performing a remote RHEL installation with an RDP client</h3>
...
<h3 id="performing-a-remote-rhel-installation-by-using-rdp-on-ibm-z">15.2. Performing a remote RHEL installation by using RDP on IBM Z</h3>
...
1. To set up a remote connection with the 64-bit IBM Z system from a local machine, open the terminal and on the command prompt, run the following command:
   ...
   $ ssh install@my-z-system-IP-address
   ```
2. The ssh session displays the following output:
...
5. Use an RDP client to connect to the provided network address.
   ...
   If you have started the installation with the `inst.rdp` boot option, the installer will not ask you to connect via ssh. Instead, provide the RDP username and password in the console, as described in the step 4 above.

<h2 id="consoles-and-logging-during-installation">Chapter 16. Consoles and logging during installation</h2>
...
<h2 id="customizing-the-system-in-the-installer">Chapter 17. Customizing the system in the installer</h2>
...
<h3 id="setting-the-installer-language">17.1. Setting the installer language</h3>
...
<h3 id="configuring-the-storage-devices">17.2. Configuring the storage devices</h3>
...
<h4 id="configuring-installation-destination">17.2.1. Configuring installation destination</h4>
...
3. Optional: Under **Storage Configuration**, select the **Automatic** radio button for automatic partitioning.
   ...
   You can also configure custom partitioning. For more details, see [Configuring manual partitioning](#configuring-manual-partitioning "17.5. Configuring manual partitioning").
...
6. Optional: Click the **Full disk summary and bootloader** link in the lower left-hand side of the window to select which storage device contains the boot loader. For more information, see [Configuring boot loader](#configuring-boot-loader "17.2.3. Configuring boot loader").
...
<h4 id="special-cases-during-installation-destination-configuration">17.2.2. Advanced considerations for installation destination configuration</h4>
...
<h4 id="configuring-boot-loader">17.2.3. Configuring boot loader</h4>
...
<h4 id="storage-device-selection">17.2.4. Storage device selection</h4>
...
<h4 id="filtering-storage-devices">17.2.5. Filtering storage devices</h4>
...
<h3 id="advanced-storage-options">17.3. Advanced storage options</h3>
...
<h4 id="discovering-and-starting-an-iscsi-session">17.3.1. Discovering and starting an iSCSI session</h4>
...
<h4 id="configuring-fcoe-parameters">17.3.2. Configuring FCoE parameters</h4>
...
<h4 id="configuring-dasd-storage-devices">17.3.3. Configuring DASD storage devices</h4>
...
<h4 id="configuring-fcp-devices">17.3.4. Configuring FCP devices</h4>
...
<h4 id="configuring-an-nvme-fabrics-devices-using-the-graphical-installation-mode">17.3.5. Configuring an NVMe fabrics devices using the graphical installation mode</h4>
...
<h3 id="configuring-the-root-user-and-creating-local-accounts">17.4. Configuring the root account and creating users</h3>

You can configure the root account and create users to access the system from the **Installation Summary** screen.

<h4 id="configuring-a-root-password">17.4.1. Configuring a root account</h4>
...
<h4 id="creating-a-user-account">17.4.2. Creating a user account</h4>
...
<h4 id="editing-advanced-user-settings">17.4.3. Editing advanced user settings</h4>
...
<h3 id="configuring-manual-partitioning">17.5. Configuring manual partitioning</h3>
...
<h4 id="recommended-partitioning-scheme">17.5.1. Recommended partitioning scheme</h4>
...
<h4 id="supported-hardware-storage">17.5.2. Supported hardware storage</h4>
...
<h4 id="starting-manual-partitioning">17.5.3. Starting manual partitioning</h4>
...
<h4 id="supported-file-systems">17.5.4. Supported file systems</h4>
...
<h4 id="adding-a-mount-point-file-system">17.5.5. Adding a file system mount point</h4>
...
<h4 id="configuring-storage-for-a-mount-point-file-system">17.5.6. Configuring storage for a mount point file system</h4>
...
<h4 id="customizing-a-mount-point-file-system">17.5.7. Customizing a mount point file system</h4>
...
<h4 id="preserving-the-home-directory">17.5.8. Preserving the /home directory</h4>
...
4. Choose the `/home` partition, fill in `/home` under `Mount Point:` and clear the **Reformat** check box.
   ...
   **Figure 17.1. Ensuring that /home is not formatted**
   
   ![Preserving Home Partition](images/preserving-home-partition-rhel-10-63a0dc490970.png) ![Preserving Home Partition](images/preserving-home-partition-rhel-10-63a0dc490970.png)
...
<h4 id="creating-a-software-raid-during-the-installation">17.5.9. Creating a software RAID during the installation</h4>
...
<h4 id="creating-an-lvm-logical-volume">17.5.10. Creating an LVM logical volume</h4>
...
<h4 id="configuring-an-lvm-logical-volume">17.5.11. Configuring an LVM logical volume</h4>
...
<h4 id="advice-on-partitions">17.5.12. Understanding disk partitioning strategies</h4>
...
<h3 id="selecting-the-base-environment-and-additional-software">17.6. Selecting the base environment and additional software</h3>
...
<h3 id="optional-configuring-the-network-and-host-name">17.7. Optional: Configuring the network and host name</h3>
...
<h4 id="configuring-network-and-host-name">17.7.1. Configuring network and host name</h4>
...
<h4 id="adding-a-virtual-network-interface">17.7.2. Adding a virtual network interface</h4>
...
3. Select the interface type and click Add. An editing interface dialog box opens, allowing you to edit any available settings for your chosen interface type. For more information, see [Editing network interface](#editing-network-interface-configuration "17.7.3. Editing network interface configuration").
...
<h4 id="editing-network-interface-configuration">17.7.3. Editing network interface configuration</h4>
...
- To configure a network connection manually, select the interface from the **Network and Host name** window and click Configure.
  ...
  An editing dialog specific to the selected interface opens. The options present depend on the connection type - the available options are slightly different depending on whether the connection type is a physical interface (wired or wireless network interface controller) or a virtual interface (Bond, Bridge, Team (deprecated), or Vlan) that was previously configured in [Adding a virtual interface](#adding-a-virtual-network-interface "17.7.2. Adding a virtual network interface").

<h4 id="enabling-or-disabling-the-interface-connection">17.7.4. Enabling or Disabling the Interface Connection</h4>
...
<h4 id="setting-up-static-ipv4-or-ipv6-settings">17.7.5. Setting up Static IPv4 or IPv6 Settings</h4>
...
<h4 id="configuring-routes">17.7.6. Configuring Routes</h4>
...
<h3 id="optional-configuring-the-keyboard-layout">17.8. Optional: Configuring the keyboard layout</h3>
...
<h3 id="optional-configuring-the-language-support">17.9. Optional: Configuring the language support</h3>
...
<h3 id="optional-configuring-the-date-and-time-related-settings">17.10. Optional: Configuring the date and time-related settings</h3>
...
<h3 id="optional-subscribing-the-system-and-activating-red-hat-insights">17.11. Optional: Subscribing the system and activating Red Hat Lightspeed</h3>
...
<h3 id="optional-using-network-based-repositories-for-the-installation">17.12. Optional: Using network-based repositories for the installation</h3>
...
3. Optional: Select the **On the network** option to download and install packages from a network location instead of local media. This option is available only when a network connection is active. See [Configuring network and host name options](#optional-configuring-the-network-and-host-name "17.7. Optional: Configuring the network and host name") for information about how to configure network connections in the GUI.
...
<h3 id="optional-configuring-kdump-kernel-crash-dumping-mechanism">17.13. Optional: Configuring Kdump kernel crash-dumping mechanism</h3>
...
<h2 id="registering-your-rhel-system">Chapter 18. Registering your RHEL system</h2>
...
<h3 id="registering-a-system-by-using-the-rhc-client-with-the-default-feature-levels">18.1. Registering a system by using the RHC client</h3>
...
<h3 id="registering-your-system-using-the-command-line">18.2. Registering your system using the subscription manager</h3>
...
<h3 id="registering-rhel-using-the-installer-gui">18.3. Registering RHEL 10 using the installer GUI</h3>
...
<h3 id="registration-assistant">18.4. Registration Assistant</h3>
...
<h3 id="registering-your-rhel-system">18.5. Additional resources</h3>
...
<h2 id="configuring-system-purpose-using-the-subscription-manager-command-line-tool">Chapter 19. Configuring System Purpose by using the subscription-manager command-line tool</h2>
...
<h2 id="post-installation-security-hardening">Chapter 20. Post-installation security hardening</h2>
...
<h2 id="changing-a-subscription-service">Chapter 21. Changing a subscription service</h2>
...
<h3 id="prerequisites">21.1. Prerequisites</h3>
...
<h3 id="unregistering-from-subscription-management-server">21.2. Unregistering from Subscription Management Server</h3>
...
<h4 id="unregistering-using-command-line">21.2.1. Unregistering using command line</h4>
...
- [Registering your system using the command line](#registering-your-system-using-the-command-line "18.2. Registering your system using the subscription manager")

<h4 id="unregistering-using-subscription-manager-user-interface">21.2.2. Unregistering by using Subscription Manager user interface</h4>
...
- [Registering your system using the Subscription Manager User Interface](#registering-your-rhel-system "Chapter 18. Registering your RHEL system")
- [Using and Configuring Red Hat Subscription Manager](https://docs.redhat.com/en/documentation/subscription_central/1-latest/html/getting_started_with_rhel_system_registration/adv-reg-rhel-using-rhsm_#understanding_rhsm_con)

<h3 id="unregistering-from-satellite-server">21.3. Unregistering from Satellite Server</h3>
...
<h2 id="changing-basic-environment-settings">Chapter 22. Changing basic environment settings</h2>
...
<h3 id="configuring-the-keyboard-layout">22.1. Configuring the keyboard layout</h3>
...
<h3 id="configuring-the-date-and-time">22.2. Manually configuring the date, time and timezone settings</h3>
...
<h3 id="configuring-the-system-locale">22.3. Configuring the system locale</h3>
...
<h2 id="configuring-a-linux-instance-on-64-bit-ibm-z">Chapter 23. Configuring a Linux instance on 64-bit IBM Z</h2>

Perform following common tasks for configuring Red Hat Enterprise Linux on 64-bit IBM Z.

<h3 id="adding-dasds-to-a-z-vm-system">23.1. Adding DASDs to a z/VM system</h3>
...
<h3 id="dynamically-setting-dasds-online">23.2. Dynamically setting DASDs online</h3>
...
2. Set the device online. Use a command of the following form:
   ...
   For instructions on how to set a DASD online persistently, see [Persistently setting DASDs online](#persistently-setting-dasds-online "23.4. Persistently setting DASDs online").

<h3 id="preparing-a-new-dasd-with-low-level-formatting">23.3. Preparing a new DASD with low-level formatting</h3>
...
<h3 id="persistently-setting-dasds-online">23.4. Persistently setting DASDs online</h3>
...
<h3 id="dasds-that-are-part-of-the-root-file-system">23.5. DASDs that are part of the root file system</h3>
...
<h3 id="dasds-that-are-not-part-of-the-root-file-system">23.6. DASDs that are not part of the root file system</h3>
...
<h3 id="fcp-luns-that-are-part-of-the-root-file-system">23.7. FCP LUNs that are part of the root file system</h3>
...
<h3 id="fcp-luns-that-are-not-part-of-the-root-file-system">23.8. FCP LUNs that are not part of the root file system</h3>
...
<h3 id="adding-a-qeth-device">23.9. Adding a qeth device</h3>
...
- [Customizing boot parameters](#customization-of-boot-parameters "9.6. Customization of boot parameters")

<h3 id="dynamically-adding-a-qeth-device">23.10. Dynamically adding a qeth device</h3>
...
<h3 id="persistently-adding-a-qeth-device">23.11. Persistently adding a qeth device</h3>
...
<h3 id="configuring-an-64-bit-ibm-z-network-device-for-network-root-file-system">23.12. Configuring an 64-bit IBM Z network device for network root file system</h3>
...
<h3 id="additional\_resources\_2">23.13. Additional resources</h3>
...
<h2 id="troubleshooting-at-the-start-of-the-installation">Chapter 24. Tools and tips for troubleshooting and bug reporting</h2>
...
<h3 id="using-installation-log-files">24.2. Using installation log files</h3>
...
Table 24.1. Log files generated during the installation
...
<h4 id="creating-pre-installation-log-files">24.2.1. Creating pre-installation log files</h4>
...
- [Boot options reference](#boot-options-reference "Chapter 26. Boot options reference")
- [Console logging during installation](#consoles-and-logging-during-installation "Chapter 16. Consoles and logging during installation")

<h4 id="transferring-installation-log-files-to-a-usb-drive">24.2.2. Transferring installation log files to a USB drive</h4>
...
<h4 id="transferring-installation-log-files-over-the-network">24.2.3. Transferring installation log files over the network</h4>
...
<h3 id="verifying-boot-media">24.3. Verifying boot media</h3>
...
<h3 id="display-settings-and-device-drivers">24.4. Display settings and device drivers</h3>
...
For more information, see [Console boot options](#console-boot-options "26.3. Console boot options").
...
<h2 id="troubleshooting-after-installation">Chapter 25. Troubleshooting after installation</h2>
...
<h3 id="resuming-an-interrupted-download-attempt">25.1. Resuming an interrupted download attempt</h3>
...
<h3 id="disks-are-not-detected">25.2. Disks are not detected</h3>
...
<h3 id="cannot-boot-with-a-raid-card">25.3. Cannot boot with a RAID card</h3>
...
<h3 id="graphical-boot-sequence-is-not-responding">25.4. Graphical boot sequence is not responding</h3>
...
<h4 id="disabling-the-graphical-boot-permanently">25.4.1. Disabling the graphical boot permanently</h4>
...
<h4 id="disabling-the-graphical-boot-temporarily">25.4.2. Disabling the graphical boot temporarily</h4>
...
<h3 id="ram-is-not-recognized">25.5. Setting the amount of memory manually if RAM is not recognized</h3>
...
<h3 id="system-is-displaying-signal-11-errors">25.6. System is displaying signal 11 errors</h3>
...
For more information, see [Verifying Boot media](#verifying-boot-media "24.3. Verifying boot media").
...
<h3 id="unable-to-ipl-from-network-storage-space-on-ibm-power-systems">25.7. Unable to IPL from network storage space on IBM Power Systems</h3>
...
<h3 id="using-rescue-mode">25.8. Using rescue mode</h3>
...
<h4 id="booting-into-rescue-mode">25.8.1. Booting into rescue mode</h4>
...
<h4 id="using-an-sos-report-in-rescue-mode">25.8.2. Using an SOS report in rescue mode</h4>
...
<h4 id="reinstalling-the-grub2-boot-loader">25.8.3. Reinstalling the GRUB2 boot loader</h4>
...
<h4 id="using-dnf-to-add-or-remove-a-driver">25.8.4. Using dnf to add or remove a driver</h4>
...
<h3 id="ip-boot-option-returns-an-error">25.9. ip= boot option returns an error</h3>
...
- [Network boot options](#network-boot-options "26.2. Network boot options")

<h3 id="cannot-boot-into-the-graphical-installation-on-ilo-or-idrac-devices">25.10. Cannot boot into the graphical installation on iLO or iDRAC devices</h3>
...
<h3 id="rootfs-image-is-not-initramfs">25.11. Rootfs image is not initramfs</h3>
...
<h2 id="boot-options-reference">Chapter 26. Boot options reference</h2>

You can use the boot options to modify the default behavior of the installation program.

<h3 id="installation-source-boot-options">26.1. Installation source boot options</h3>
...
- an ISO image of the full Red Hat Enterprise Linux installation DVD, placed on a disk or a network location accessible to the system.
  ...
  Table 26.1. Types and format for the inst.repo= boot option and installation source
  ...
  Installation DVD as a physical disk. [\[a\]](#ftn.idm140554892827344)
  ...
  Image file of the installation DVD, or an installation tree, which is a complete copy of the directories and files on the installation DVD. [\[b\]](#ftn.idm140554892812144)
  ...
  [\[a\]](#idm140554892827344) If *device* is left out, installation program automatically searches for a drive containing the installation DVD.
  
  [\[b\]](#idm140554892812144) The NFS Server option uses NFS protocol version 3 by default. To use a different version, add `nfsvers=X` to *options*, replacing *X* with the version number that you want to use.
...
- File system UUID, for example `UUID=8176c7bf-04ff-403a-a832-9557f94e61db`
  ...
  Table 26.2. Installation sources and boot option format
...
<h3 id="network-boot-options">26.2. Network boot options</h3>
...
- The `hostname` parameter is the host name of the client system. This parameter is optional.
  ...
  Table 26.3. Boot option formats to configure the network interface
...
<h3 id="console-boot-options">26.3. Console boot options</h3>
...
<h3 id="debug-boot-options">26.4. Debug boot options</h3>
...
Table 26.4. updates.img file sources
...
<h3 id="storage-boot-options">26.5. Storage boot options</h3>
...
<h2 id="idm140554908469424">Legal Notice</h2>
